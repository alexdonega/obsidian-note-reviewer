...
Leia o **README.md** na raiz desta pasta para entender o contexto geral.
...
```bash
cd weeks-01-04-security-architecture/
# Arquivos-chave:
...
```bash
cd weeks-07-08-observability-performance/
# Arquivos-chave:
...
```bash
cd weeks-11-12-excellence-launch/
# Arquivos-chave:
...
3. **Para preparar o lançamento:**
   - weeks-11-12-excellence-launch/LAUNCH-CHECKLIST.md
   - weeks-09-10-monetization/pricing.ts

## 🔍 Buscar Algo Específico?

### Autenticação/Segurança
→ `weeks-01-04-security-architecture/`

### Real-time/WebSockets
→ `weeks-05-06-cloud-realtime/realtime.ts`

### Performance/Load Testing
→ `weeks-07-08-observability-performance/load/`

### Stripe/Pagamentos
→ `weeks-09-10-monetization/stripe.ts`

### Documentação API
→ `weeks-11-12-excellence-launch/openapi.yaml`

### CI/CD Pipeline
→ `weeks-11-12-excellence-launch/deploy-production.yml`

### Monitoring
→ `weeks-11-12-excellence-launch/alerts.yaml`
